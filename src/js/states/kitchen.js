...
Kitchen.prototype = {
  ...
  create: function () {
	...
	this.wheatText = this.game.add.text(16, 16, this.getTextKitchen(), { fontSize: '22px', fill: '#000' });
  ...
  update: function () {
	...
	this.game.physics.arcade.overlap(this.player, this.wheat, this.collectKitchen, null, this);
  ...
  collectKitchen: function(me, wheat)
  {
  ...
  addGrain: function(val)
  {
	...
	playerState.inventory.grainKitchen += 5;
	this.wheatText.text = this.getTextKitchen();
  },

  getTextKitchen: function()
  {
	 return 'Kitchen Grain: ' + playerState.inventory.grainKitchen;
  },
